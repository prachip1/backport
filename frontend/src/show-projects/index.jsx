...
<button className="btn bg-gray-900 text-gray-300 py-4  w-48 rounded-md font-normal tracking-tighter text-base"><a href="https://github.com/prachip1" target="_blank">Check more on GitHub.</a></button>
</div>
